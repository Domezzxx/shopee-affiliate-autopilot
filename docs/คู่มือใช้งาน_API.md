...
|------|-----|----------|---------|-----------|
| 1 | **Gemini** | เขียนแคปชั่น + สร้างภาพ | 🟢 ฟรี | **ต้องมี** (หัวใจ) |
| 2 | **YouTube** | โพสต์ Shorts อัตโนมัติ | 🟢 ฟรี | ถ้าจะโพสต์ YouTube |
| 3 | **Apify** | ดึงร้าน/สินค้า Shopee | 🟢 ฟรี $5 | ถ้าจะดึงร้านอัตโนมัติ |
| 4 | **Shopee Affiliate** | สร้างลิงก์ affiliate (คอมมิชชั่นเข้าพี่กอล์ฟ) | 🟢 ฟรี | **ต้องมี** ถ้าจะได้เงิน |
| 5 | **Meta (FB+IG)** | โพสต์ Facebook + Instagram | 🟢 ฟรี* | ถ้าจะโพสต์ FB/IG |
| 6 | Claude (Anthropic) | เขียนแคปชั่น (คุณภาพสูงกว่า) | 🔴 จ่าย | ไม่จำเป็น (มี Gemini แล้ว) |

> \* Meta ฟรี แต่ต้องผ่าน "App Review" ถึงจะโพสต์เพจคนอื่นได้ (เพจตัวเองทดสอบได้เลย)

> 🎬 **วีดีโอ + เสียง = Google Flow** (ไม่ใช่ API key — ใช้ล็อกอิน Chrome ดูส่วน "ของที่ไม่ใช่ API") · Flow สร้างได้**ทั้งวีดีโอและเสียงในตัว** + ระบบยังเติม**เสียงพากย์ไทยฟรี** (edge-tts ไม่ต้องขอ key) ให้ทุกคลิป
> 🚫 **เลิกใช้แล้ว:** Pexels (stock video) + Freesound (เสียงบรรยากาศ) — ไม่ต้องขอ เพราะ Flow ทำวีดีโอ+เสียงเองได้หมด

**ขั้นต่ำที่สุด:** มีแค่ **Gemini** ตัวเดียว + ล็อกอิน **Google Flow** ระบบก็ทำคลิปมีเสียงได้แล้ว · อยากโพสต์ค่อยเพิ่ม YouTube/Meta
...
|-----|-------------|--------------|--------------------------|
| **Gemini** (ข้อความ+ภาพ) | ฟรี — ลิมิตต่อนาที/วัน พอใช้จริง | เกินลิมิตหนักๆ | ข้อความ+ภาพ ~ฟรี |
| **Google Flow** (วีดีโอ+เสียง) | ฟรี — เครดิตจำกัดต่อวัน | อยากได้เครดิตเยอะ | Google AI Pro ~฿700/เดือน (เครดิต Flow เยอะขึ้น) |
| **เสียงพากย์ไทย** (edge-tts) | ฟรี 100% — ไม่ต้องขอ key | ไม่มี | ฿0 |
...
- Gemini (ฟรี) + Google Flow (วีดีโอ+เสียง ฟรี) + เสียงพากย์ไทย (ฟรี) + YouTube + Shopee Affiliate
- ทำคลิปมีเสียง + โพสต์ YouTube + มีลิงก์ทำเงิน ได้ครบ
...
**ใช้:** เขียนแคปชั่น/สคริปต์ + สร้างภาพอาหาร (Nano Banana) · *(วีดีโอ+เสียงทำผ่าน Google Flow ดูส่วนล่าง)*
...
## 3️⃣ Apify — 🟢 ฟรี ($5 เครดิต/เดือน) — ดึงร้าน Shopee
...
## 4️⃣ Shopee Affiliate API — 🟢 ฟรี — **ตัวทำเงิน!** 💰
...
## 5️⃣ Meta (Facebook + Instagram) — 🟢 ฟรี — โพสต์ FB/IG
...
## 6️⃣ Claude (Anthropic) — 🔴 จ่ายเงิน — ไม่จำเป็น
...
|------|---------|---------|
| **Google Flow** ⭐ (วีดีโอ+เสียง ฟรี) | ไม่ใช่ key — ใช้ล็อกอินใน Chrome · สร้าง**วีดีโอจากรูป product จริง พร้อมเสียงในตัว** (image-to-video) | รัน `./scripts/start.ps1` (เปิด Chrome ให้) → ล็อกอิน labs.google/flow ครั้งเดียว · ต้องเปิด `ENABLE_VIDEO=true` ใน `.env` |
| **เสียงพากย์ไทย** (edge-tts ฟรี) | ไม่ใช่ key — ทุกคลิปมีเสียงพากย์ไทยอัตโนมัติ | เปิดอยู่แล้ว (`ENABLE_VOICEOVER=true`) · เปลี่ยนเสียงที่ `TTS_VOICE` |
...
1. **Gemini** + ล็อกอิน **Google Flow** (ทำคลิปมีเสียงได้เลย) → 2. **Shopee Affiliate** (ได้ลิงก์ทำเงิน 💰) → 3. **YouTube** (โพสต์ได้) → 4. **Apify** (ดึงร้านเอง) → 5. **Meta** (เปิด FB/IG ตอนพร้อมจริง)

> 💰 **เน้น:** Gemini + Google Flow (ทำคลิป**มีเสียงไทย**) + Shopee Affiliate (ลิงก์ทำเงิน) + YouTube (ช่องทางโพสต์) = ครบชุดเริ่มหาเงินได้
> 🚫 Pexels / Freesound = **เลิกใช้แล้ว** (Flow ทำวีดีโอ+เสียงเองได้หมด)
