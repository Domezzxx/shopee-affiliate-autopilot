...
| 6 | **Meta (FB+IG)** | โพสต์ Facebook + Instagram | 🟢 ฟรี* | ถ้าจะโพสต์ FB/IG |
| 7 | Claude (Anthropic) | เขียนแคปชั่น (คุณภาพสูงกว่า) | 🔴 จ่าย | ไม่จำเป็น (มี Gemini แล้ว) |
...
## 6️⃣ Meta (Facebook + Instagram) — 🟢 ฟรี — โพสต์ FB/IG
...
## 7️⃣ Claude (Anthropic) — 🔴 จ่ายเงิน — ไม่จำเป็น
...
1. **Gemini** (ทำคลิปได้เลย) → 2. **Pexels + Freesound** (คลิปสวยขึ้น) → 3. **YouTube** (โพสต์ได้) → 4. **Apify** (ดึงร้านเอง) → 5. **Meta** (เปิด FB/IG ตอนพร้อมจริง)
